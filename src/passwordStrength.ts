...
class PasswordCheckService {
    ...
    public checkPasswordStrength(password: string): PasswordCheckStrength {
        ...
        console.log("Short: " + PasswordCheckStrength.Short); //0
        console.log("Common: " + PasswordCheckStrength.Common); //1
        console.log("Weak: " + PasswordCheckStrength.Weak); //2
        console.log("Ok: " + PasswordCheckStrength.Ok); //3 
        console.log("Strong: " + PasswordCheckStrength.Strong); // 4
